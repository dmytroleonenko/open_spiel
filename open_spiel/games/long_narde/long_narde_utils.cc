  ...
  namespace long_narde
  {
    ...
    std::string LongNardeState::ToString() const
    {
      if (IsTerminal())
      {
        ...
        // Optionally, include the final board string if desired, e.g.:
        // terminal_str += BoardToString();
        return terminal_str;
      }
                                               ...
                                               Action move_id) const
    {
      ...
      for (const auto &move : cmoves)
      {
        ...
        {                           // White's perspective (kXPlayerId)
    ...
    int LongNardeState::GetPathIndex(int player, int real_pos) const
    {
      ...
      { // Path: 11 -> 0 -> 23 -> 12
        ...
        { // First half: 11 down to 0
          // Index 0 = pos 11, Index 1 = pos 10, ..., Index 11 = pos 0
          return 11 - real_pos;
        }
        else
        { // Second half: 23 down to 12
